...
void EnemyShipTypeB::update(const KeyboardEvent& keyPress, 
...
void EnemyShipTypeB::handleInterraction(const Interraction& interraction, 
...
void EnemyShipTypeB::updateDuePlayerInputs(const KeyboardEvent& keyPress, 
											const MouseEvent& mousePress)
{
